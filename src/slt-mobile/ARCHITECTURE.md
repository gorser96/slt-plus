...
## Текущее состояние на 2026-09-09

Это описание разделяет реализованное устройство и целевой план. Разделы 1–28 ниже
содержат **целевую архитектуру**, включая ещё не реализованные компоненты и примеры.
Они не являются свидетельством наличия перечисленных технологий в приложении.
